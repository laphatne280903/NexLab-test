...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SplashStatus status, String? error});
}
...
class _$SplashStateImpl implements _SplashState {
  const _$SplashStateImpl({this.status = SplashStatus.initial, this.error});
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({final SplashStatus status, final String? error}) =
      _$SplashStateImpl;
